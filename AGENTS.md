...
- **Sechs autorierte Trainer-Typen** pro Lektion in fester Rangfolge (Visueller Spurensucher → … → Satz-Versteher → Rechnen). Reihenfolge fällt nicht zurück; `ContentValidator` erzwingt Struktur. Zur Laufzeit können sich abgeleitete Zusatz-Trainer (Jagd, Wort-Detektiv, siehe unten) dazwischenschieben — sie sind keine siebten/achten autorierten Typen.
